...
ALTER TABLE {$this->getTable('sales_flat_order')} ADD `customercredit_discount` decimal(12,4) NOT NULL;
ALTER TABLE {$this->getTable('sales_flat_order')} ADD `base_customercredit_discount` decimal(12,4) NOT NULL;
");

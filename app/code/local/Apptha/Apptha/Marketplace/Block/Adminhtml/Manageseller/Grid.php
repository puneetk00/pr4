...
class Apptha_Marketplace_Block_Adminhtml_Manageseller_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
		...
		/****Documents****/
		// $this->addColumn ( 'uploadeddoc', array (
                // 'header' => Mage::helper ( 'marketplace' )->__ ( 'Documents' ),
                // 'width' => '80',
                // 'type' => 'action',
                // 'getter' => 'getId',
                // 'actions' => array (
                        // array (
                                // 'caption' => Mage::helper ( 'marketplace' )->__ ( 'Documents' ),
                                // 'url' => array (
                                        // 'base' => '*/*/documents/' 
                                // ),
                                // 'field' => 'id',
                                // 'title' => Mage::helper ( 'marketplace' )->__ ( 'Documents' ) 
                        // ) 
                // ),
                // 'filter' => false,
                // 'sortable' => false,

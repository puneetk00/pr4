...
class Apptha_Marketplace_SellerController extends Mage_Core_Controller_Front_Action {
    ...
    function saveprofileAction() {
       ...
       // $signature = Mage::getModel('marketplace/seller')->docUpload( $filesDataArray, $docpath, 'signature' );
		...
		//$query = "replace into marketplace_sellerdoc set id = null, seller_id = '{$sellerId}',doc = {$documents},gstin = '{$gstin}',pan = '{$pan}', tan= '{$tan}',cancel_cheque = '{$cancel_cheque}',vat_certificate = '{$vat_certificate}', address_proof = '{$address_proof}', owner_identity_proof = '{$owner_identity_proof}', signature = '{$signature}')";
